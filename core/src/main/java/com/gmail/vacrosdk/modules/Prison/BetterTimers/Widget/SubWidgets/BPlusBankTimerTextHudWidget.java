...
public class BPlusBankTimerTextHudWidget extends TimerWidget {

  public BPlusBankTimerTextHudWidget(String id, FreakyvilleAddon addon, Icon icon) {
    super(id, addon, icon);
  }

  @Override
  public String getStringTimeLeft() {
    return HotSpots.BPLUS_VAULT.getHotSpot().getTimeLeft();
  }

  @Override
  public String getHotSpotName() {
    return HotSpots.BPLUS_VAULT.getHotSpot().getHotSpotName();
  }
}
