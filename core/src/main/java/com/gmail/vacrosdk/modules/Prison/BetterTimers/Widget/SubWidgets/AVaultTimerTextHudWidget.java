...
public class AVaultTimerTextHudWidget extends TimerWidget {

  public AVaultTimerTextHudWidget(String id, Icon icon, FreakyvilleAddon addon) {
    super(id, addon, icon);
  }

  @Override
  public String getStringTimeLeft() {
    return HotSpots.A_VAULT.getHotSpot().getTimeLeft();
  }

  @Override
  public String getHotSpotName() {
    return HotSpots.A_VAULT.getHotSpot().getHotSpotName();
  }
}
